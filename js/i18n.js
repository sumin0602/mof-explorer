...
(function () {
  ...
  var DICT = {
    ko: {
      ...
      'footer.text': '© 2026 MOF Explorer · 중·고등학생을 위한 나노 과학 교육 플랫폼',
    ...
    en: {
      ...
      'footer.text': '© 2026 MOF Explorer · A nano-science learning platform for middle & high schoolers',
  ...
  var KO2EN = {
    ...
    "금속 노드 헌트": "Metal Node Hunt",
    "🎯 금속 노드 헌트": "🎯 Metal Node Hunt",
    "금속 노드 8개 클릭으로 찾기": "Click to find 8 metal nodes",
    "찾은 노드": "Nodes found",
    "찾을 금속 노드": "Metal nodes to find",
    "금속 노드를 클릭해 찾기!": "Click the metal nodes to find them!",
    "💡 색이 있는 큰 구(금속 노드)를 클릭하세요. 연속으로 맞히면 콤보 보너스!": "💡 Click the big colored spheres (metal nodes). Chain hits for a combo bonus!",

    // ================= easy games (middle-school) =================
    "색깔 탐정": "Color Detective",
    "노드 vs 리간드": "Node vs Linker",
    "통과할까?": "Will It Fit?",
    "원소마다 색이 달라요": "Each element has a color",
    "색을 보고 원소 맞히기": "Guess the element by color",
    "MOF의 두 조각": "The two parts of a MOF",
    "노드일까 리간드일까?": "Node or linker?",
    "기공보다 작으면 통과!": "Smaller than the pore = pass!",
    "분자가 통과할지 O/X": "Will the molecule pass? O/X",
    "중학생 추천 · 쉬움": "Middle-school · Easy",
    "— 8가지 학습 게임 —": "— 8 learning games —",
    "이 색깔은 어떤 원소일까요?": "Which element is this color?",
    "이것은 무엇일까요?": "What is this?",
    "이 분자가 기공을 통과할 수 있을까요?": "Can this molecule pass through the pore?",
    "🟠 금속 노드": "🟠 Metal node",
    "🔗 유기 리간드": "🔗 Organic linker",
    "⭕ 통과": "⭕ Passes",
    "❌ 막힘": "❌ Blocked",
    "구리 (Cu)": "Copper (Cu)",
    "아연 (Zn)": "Zinc (Zn)",
    ...
    "탄소 (C)": "Carbon (C)",
    "질소 (N)": "Nitrogen (N)",
    "구리·아연 같은 금속 이온": "Metal ions like copper and zinc",
    "BTC·BDC 같은 막대 모양 유기 분자": "Rod-shaped organic molecules like BTC and BDC",
    "구조의 모서리 역할을 하는 금속 클러스터": "A metal cluster that forms the structure's corner",
    "금속 노드 사이를 연결하는 유기 분자": "An organic molecule that connects metal nodes",
    "Zn₄O 클러스터 (MOF-5의 중심)": "A Zn₄O cluster (the center of MOF-5)",
    "테레프탈산(BDC) 분자": "A terephthalic acid (BDC) molecule",
    "지르코늄 6개로 된 클러스터": "A cluster of six zirconium atoms",
    "이미다졸 링커": "An imidazole linker",
    "기공 크기": "Pore size",
    "물 (H₂O)": "Water (H₂O)",
    "이산화탄소 (CO₂)": "Carbon dioxide (CO₂)",
    "메탄 (CH₄)": "Methane (CH₄)",
    "질소 (N₂)": "Nitrogen (N₂)",
    "수소 (H₂)": "Hydrogen (H₂)",
    "각 원소는 3D 뷰어에서 고유한 색으로 표시돼요.": "Each element is shown in its own color in the 3D viewer.",
    "금속 이온·클러스터는 노드, 유기 분자는 리간드예요.": "Metal ions and clusters are nodes; organic molecules are linkers.",
    "분자가 기공보다 작으면 통과, 크면 막혀요.": "A molecule passes if it's smaller than the pore, and is blocked if it's bigger.",
    ...
    "훌륭한 실력!": "Great work!",
    "잘했어요!": "Well done!",
    "도전 완료! 한 번 더?": "Challenge complete! One more?",
    "최종 점수": "Final score",
    "정확도": "Accuracy",
    "소요 시간": "Time taken",
    "랭킹 등록": "Submit score",
    ...
    // ================= game.js — quiz (rendered as text nodes) =================
    "MOF는 금속 이온과 유기 리간드로 이루어진 다공성 결정이다.": "A MOF is a porous crystal made of metal ions and organic ligands.",
    "MOF = Metal-Organic Framework. 금속 노드와 유기 리간드가 배위결합으로 연결된 다공성 구조체입니다.": "MOF = Metal-Organic Framework: a porous structure where metal nodes and organic ligands are joined by coordination bonds.",
    "HKUST-1의 금속 노드는 아연(Zn)이다.": "HKUST-1's metal node is zinc (Zn).",
    "HKUST-1의 금속 노드는 구리(Cu)입니다. Zn 기반 MOF는 MOF-5입니다.": "HKUST-1's metal node is copper (Cu). The Zn-based MOF is MOF-5.",
    "MOF는 기공 크기를 설계 단계에서 조절할 수 있다.": "You can tune a MOF's pore size at the design stage.",
    "리간드의 길이와 금속 노드의 종류를 바꾸면 기공 크기를 나노 수준에서 조절할 수 있습니다.": "By changing the ligand length and the type of metal node, pore size can be tuned at the nanometer scale.",
    "MOF의 비표면적은 최대 1g당 7,000m²에 달할 수 있다.": "A MOF's surface area can reach up to 7,000 m² per gram.",
    "일부 MOF는 기존 활성탄보다 훨씬 높은 비표면적을 가집니다.": "Some MOFs have far higher surface areas than conventional activated carbon.",
    "HKUST-1은 수분에 장기 노출되어도 구조 안정성이 유지된다.": "HKUST-1 keeps its structural stability even after long exposure to moisture.",
    "HKUST-1의 열린 Cu 사이트는 물 분자와 강하게 상호작용하여 장기 노출 시 구조 안정성이 저하됩니다.": "HKUST-1's open Cu sites interact strongly with water molecules, so long exposure lowers its structural stability.",
    "MOF-5의 네트 구조는 pcu(Primitive Cubic net)이다.": "MOF-5's net structure is pcu (Primitive Cubic net).",
    "MOF-5는 6면체 구조가 반복되는 pcu 네트입니다.": "MOF-5 is a pcu net — a repeating cubic (six-faced) structure.",
    "MOF는 크로마토그래피의 고정상으로 활용될 수 없다.": "MOFs cannot be used as a stationary phase in chromatography.",
    "MOF는 넓은 비표면적과 균일한 기공으로 GC·HPLC 고정상으로 활용됩니다.": "With their large surface area and uniform pores, MOFs are used as stationary phases in GC and HPLC.",
    "2차 빌딩유닛(SBU)은 MOF에서 반복적으로 배치되는 무기물 부분이다.": "A secondary building unit (SBU) is the inorganic part repeated throughout a MOF.",
    "SBU(Secondary Building Unit)는 금속 클러스터 부분으로 구조의 노드 역할을 합니다.": "The SBU (Secondary Building Unit) is the metal-cluster part that acts as the node of the structure.",
    "UiO-66의 금속 노드는 구리(Cu)이다.": "UiO-66's metal node is copper (Cu).",
    "UiO-66의 금속 노드는 지르코늄(Zr)입니다. 열·화학적 안정성이 높은 MOF입니다.": "UiO-66's metal node is zirconium (Zr). It's a MOF with high thermal and chemical stability.",
    "MOF는 CO₂ 포집 및 저장 소재로 활용 가능하다.": "MOFs can be used as materials for capturing and storing CO₂.",
    "HKUST-1 등은 CO₂의 사중극자 모멘트와 강하게 상호작용해 선택적 흡착이 가능합니다.": "MOFs like HKUST-1 interact strongly with CO₂'s quadrupole moment, allowing selective adsorption.",
    "HKUST-1의 유기 리간드는 무엇인가?": "What is HKUST-1's organic ligand?",
    "BDC (벤젠디카르복실산)": "BDC (benzenedicarboxylic acid)",
    "BTC (벤젠트리카르복실산)": "BTC (benzenetricarboxylic acid)",
    "BTB (벤젠트리벤조산)": "BTB (benzenetribenzoic acid)",
    "BPY (바이피리딘)": "BPY (bipyridine)",
    "HKUST-1은 Cu₃(BTC)₂로, 1,3,5-벤젠트리카르복실산(BTC) 리간드를 사용합니다.": "HKUST-1 is Cu₃(BTC)₂ and uses the 1,3,5-benzenetricarboxylic acid (BTC) ligand.",
    "MOF에서 기공(pore)의 역할로 가장 적절한 것은?": "What best describes the role of pores in a MOF?",
    "금속 이온 간 전자 전달": "Electron transfer between metal ions",
    "게스트 분자의 저장 및 선택적 흡착": "Storing and selectively adsorbing guest molecules",
    "유기 리간드의 산화 방지": "Preventing oxidation of the organic ligands",
    "결정 구조의 열팽창 완충": "Buffering the crystal's thermal expansion",
    "기공은 외부 분자(기체, 액체)를 선택적으로 흡착·저장하는 핵심 공간입니다.": "Pores are the key spaces that selectively adsorb and store outside molecules (gases, liquids).",
    "MOF-5의 금속 노드를 구성하는 이온은?": "Which ion makes up MOF-5's metal node?",
    "MOF-5는 Zn₄O(BDC)₃로, Zn²⁺ 4개가 산소 1개를 중심으로 클러스터를 형성합니다.": "MOF-5 is Zn₄O(BDC)₃, where four Zn²⁺ ions form a cluster around one central oxygen.",
    "다음 중 MOF의 응용 분야가 아닌 것은?": "Which of these is NOT a MOF application?",
    "반도체 소자 제작": "Semiconductor device fabrication",
    "반도체 소자 제작은 주로 실리콘 기반 공정으로, 현재 MOF의 주요 응용 분야가 아닙니다.": "Semiconductor fabrication is mainly a silicon-based process and isn't a major MOF application today.",
    "HKUST-1 활성화 후 형성되는 열린 금속 사이트가 특히 강하게 흡착하는 분자는?": "After activation, which molecule do HKUST-1's open metal sites adsorb especially strongly?",
    "CO₂는 사중극자 모멘트가 커서 Cu 열린 금속 사이트와 강하게 상호작용합니다.": "CO₂ has a large quadrupole moment, so it interacts strongly with the open Cu metal sites.",
    "MOF의 구조를 기술하는 명명법에서 pcu가 의미하는 것은?": "In MOF structure notation, what does 'pcu' mean?",
    "pcu는 Primitive Cubic net으로, MOF-5처럼 6면체 구조가 반복되는 네트입니다.": "'pcu' means Primitive Cubic net — a repeating cubic net like MOF-5's.",
    "다음 중 수분 안정성이 가장 높은 MOF는?": "Which MOF has the highest moisture stability?",
    "UiO-66은 Zr 금속 노드 기반으로 열적·화학적 안정성이 높아 수분에 강합니다.": "UiO-66 is based on Zr metal nodes with high thermal and chemical stability, so it resists moisture.",
    "크로마토그래피에서 MOF를 고정상으로 사용할 때 장점이 아닌 것은?": "Which is NOT an advantage of using a MOF as a chromatography stationary phase?",
    "균일한 기공 크기": "Uniform pore size",
    "넓은 비표면적": "Large surface area",
    "높은 전기전도성": "High electrical conductivity",
    "조절 가능한 표면 극성": "Tunable surface polarity",
    "대부분의 MOF는 전기 절연체입니다. 전기전도성은 MOF 고정상의 장점이 아닙니다.": "Most MOFs are electrical insulators, so conductivity isn't an advantage for MOF stationary phases.",
    "MOF의 기공 크기를 조절하는 가장 직접적인 방법은?": "What's the most direct way to control a MOF's pore size?",
    "온도 변화": "Changing temperature",
    "유기 리간드의 길이 조절": "Adjusting the organic ligand length",
    "용매 교체": "Swapping the solvent",
    "압력 증가": "Increasing pressure",
    "리간드가 길수록 노드 간 거리가 늘어나 기공이 커집니다. 리간드 설계가 핵심입니다.": "Longer ligands increase the distance between nodes, making pores larger. Ligand design is key.",
    "IUPAC이 MOF를 정의할 때 핵심으로 제시한 개념은?": "What key idea did IUPAC use to define a MOF?",
    "고온 안정성": "High-temperature stability",
    "잠재적 공극을 갖는 배위화합물": "A coordination compound with potential voids",
    "무기 결정 구조": "An inorganic crystal structure",
    "공유결합 네트워크": "A covalent network",
    "IUPAC은 MOF를 \"유기물 리간드와 잠재적 공극을 갖는 배위화합물\"로 정의합니다.": "IUPAC defines a MOF as \"a coordination compound with organic ligands and potential voids.\"",
    "⭕ O (맞다)": "⭕ O (True)",
    "❌ X (틀리다)": "❌ X (False)",
    "O (맞다)": "O (True)",
    "X (틀리다)": "X (False)",

    // ================= game.js — adsorption + flashcards =================
    "구리(Cu) 열린 금속 사이트 보유 | 기공 크기 ~9Å | 사중극자 분자와 강한 상호작용": "Has open copper (Cu) metal sites | pore size ~9 Å | strong interaction with quadrupolar molecules",
    "구리(Cu) 열린 금속 사이트 보유 | 수분 노출 시 구조 변화 발생": "Has open copper (Cu) metal sites | structure changes on moisture exposure",
    "물 분자는 Cu 열린 사이트와 강하게 결합해 구조를 변화시킵니다 (단점이기도 함).": "Water molecules bind strongly to the open Cu sites and change the structure (which is also a drawback).",
    "아연(Zn) 노드 | 큰 기공(~15Å) | 무극성 표면 | 수소 저장 연구에 활용": "Zinc (Zn) nodes | large pores (~15 Å) | nonpolar surface | used in hydrogen-storage research",
    "MOF-5는 큰 기공과 무극성 표면으로 수소(H₂) 저장 연구에 주로 활용됩니다.": "With large pores and a nonpolar surface, MOF-5 is mainly used in hydrogen (H₂) storage research.",
    "지르코늄(Zr) 노드 | 기공 크기 ~6Å | 높은 열·수분 안정성": "Zirconium (Zr) nodes | pore size ~6 Å | high thermal and moisture stability",
    "UiO-66은 수분 안정성이 높아 실제 환경(습기 존재)에서도 CO₂를 선택적으로 흡착할 수 있습니다.": "UiO-66's high moisture stability lets it selectively adsorb CO₂ even in real, humid environments.",
    "바이오가스 정제 조건 | CO₂/CH₄ 혼합 기체에서 선택적 분리 목표": "Biogas-purification setting | goal: selectively separate a CO₂/CH₄ mixture",
    "HKUST-1은 CO₂/CH₄ 분리에서 CO₂를 우선 흡착해 바이오가스의 CH₄ 순도를 높입니다.": "In CO₂/CH₄ separation, HKUST-1 preferentially adsorbs CO₂, raising the CH₄ purity of biogas.",
    "초급": "Beginner",
    "중급": "Intermediate",
    "심화": "Advanced",
    "금속 이온과 유기 리간드로 이루어진 다공성 결정 구조체": "A porous crystalline structure made of metal ions and organic ligands",
    "기공 (Pore)": "Pore",
    "게스트 분자가 저장·흡착되는 MOF 내부의 빈 공간": "The empty space inside a MOF where guest molecules are stored and adsorbed",
    "리간드 (Ligand)": "Ligand",
    "MOF에서 금속 노드를 연결하는 유기 분자 (스페이서)": "The organic molecule (spacer) that links metal nodes in a MOF",
    "노드 (Node)": "Node",
    "MOF 구조에서 금속 이온 또는 금속 클러스터 부분": "The metal-ion or metal-cluster part of a MOF structure",
    "Cu₃(BTC)₂, 구리 노드와 BTC 리간드로 이루어진 대표적 MOF": "Cu₃(BTC)₂ — a classic MOF of copper nodes and BTC ligands",
    "물질 1g이 가지는 총 표면적 (MOF는 최대 7,000m²/g)": "The total surface area in 1 g of a material (up to 7,000 m²/g for MOFs)",
    "2차 빌딩유닛, MOF에서 반복 배치되는 무기물(금속 클러스터) 부분": "Secondary Building Unit — the inorganic (metal-cluster) part repeated throughout a MOF",
    "pcu 네트": "pcu net",
    "Primitive Cubic net, MOF-5의 6면체 반복 구조 명칭": "Primitive Cubic net — the name for MOF-5's repeating cubic structure",
    "열린 금속 사이트": "Open metal site",
    "활성화 후 배위 용매가 제거되어 노출된 금속 이온 자리": "A metal-ion site exposed after activation removes the coordinating solvent",
    "CIF 파일": "CIF file",
    "결정 구조의 원자 좌표·격자 정보를 담은 결정학 데이터 파일": "A crystallography data file holding a crystal's atomic coordinates and lattice info",
    "Zr 노드 기반 MOF, 열·수분 안정성이 높아 실제 환경 적용에 유리": "A Zr-node MOF with high thermal and moisture stability, good for real-world use",
    "흡착 선택성": "Adsorption selectivity",
    "특정 분자만 우선 흡착하는 MOF의 기공 특성 (크기·극성 기반)": "A MOF pore property that preferentially adsorbs only certain molecules (by size and polarity)",
    "사중극자 모멘트": "Quadrupole moment",
    "CO₂가 가지는 전기적 비대칭 특성, HKUST-1과의 강한 상호작용 원인": "CO₂'s electrical asymmetry — the reason for its strong interaction with HKUST-1",
    "breakthrough 실험": "Breakthrough experiment",
    "혼합 기체를 흘려보내 특정 성분의 흡착·분리 성능을 측정하는 실험": "An experiment that flows a gas mixture through to measure adsorption/separation performance",
    "가역적 흡탈착": "Reversible ad/desorption",
    "조건 변화에 따라 흡착과 탈착이 반복 가능한 특성 (수소 저장 필수 조건)": "The ability to adsorb and desorb repeatedly as conditions change (essential for hydrogen storage)",
    "배위화합물": "Coordination compound",
    "금속 이온에 리간드가 배위결합으로 연결된 화합물 (MOF의 상위 개념)": "A compound where ligands bind a metal ion by coordination bonds (the broader class MOFs belong to)",
    "동적 기공": "Dynamic pore",
    "외부 자극이나 게스트 분자에 반응해 크기·형태가 변하는 MOF 기공": "A MOF pore that changes size or shape in response to stimuli or guest molecules",
    "Zn₄O(BDC)₃, 최초의 안정적·고기공성 MOF로 Yaghi가 1999년 Nature에 발표": "Zn₄O(BDC)₃ — the first stable, high-porosity MOF, published by Yaghi in Nature (1999)",
    "아직 기록이 없습니다. 첫 탐험가가 되어보세요!": "No records yet. Be the first explorer!",
    "숨겨진 기공:": "Hidden pores:",
    "정말 게임을 종료하시겠습니까?": "Are you sure you want to quit the game?",
    "랭킹을 모두 초기화하시겠습니까?": "Reset the entire leaderboard?",
    "⭕❌ OX 문제": "⭕❌ True / False",
    ...
    "입니다.": ".",
    "점": " pts",
    "(빠른 정답 보너스)": " (fast-answer bonus)",
    "(힌트 사용)": " (hint used)",
    "⚠ 틀린 문제": "⚠ Wrong answers",
    "로드 실패": "failed to load",

    // ================= structure.js — 3D info panels =================
    "🟠 금속 노드 (구리)": "🟠 Metal node (Copper)",
    "🟠 금속 노드 (아연)": "🟠 Metal node (Zinc)",
    "🟠 금속 노드 (지르코늄)": "🟠 Metal node (Zirconium)",
    "🟠 금속 노드 (크롬)": "🟠 Metal node (Chromium)",
    "🟠 금속 노드 (코발트)": "🟠 Metal node (Cobalt)",
    "🟠 금속 노드 (마그네슘)": "🟠 Metal node (Magnesium)",
    "🟠 금속 노드 (알루미늄)": "🟠 Metal node (Aluminum)",
    "🔵 유기 리간드 (Linker)": "🔵 Organic ligand (Linker)",
    "금속 노드 사이를 잇는": "Acts as the",
    "막대": "rod",
    "역할을 합니다.": "that links the metal nodes.",
    "HKUST-1의 패들휠 클러스터 — 두 개의 Cu 이온이 4개의 카르복실기 산소와 결합. CO₂·H₂O 흡착자리(외부 빈자리)로 활용.": "HKUST-1's paddle-wheel cluster — two Cu ions bind to four carboxylate oxygens. Serves as an adsorption site (open coordination site) for CO₂ and H₂O.",
    "MOF-5의 Zn₄O 사면체 클러스터 — 4개의 Zn 이온이 중심 산소를 둘러싸고 BDC 카르복실기와 결합. 결정의 모서리. (ZIF 계열에서는 Zn이 이미다졸의 질소와 결합)": "MOF-5's Zn₄O tetrahedral cluster — four Zn ions surround a central oxygen and bind to BDC carboxylates. The corners of the crystal. (In ZIFs, Zn instead binds to imidazole nitrogen.)",
    "UiO-66의 Zr₆O₄(OH)₄ 옥타헤드론 — 6개의 Zr 이온이 8개의 산소/하이드록시드와 결합한 매우 안정한 클러스터. 열·물·산 안정성 최강.": "UiO-66's Zr₆O₄(OH)₄ octahedron — six Zr ions bound to eight oxygens/hydroxides form a very stable cluster. Top stability against heat, water, and acid.",
    "MIL 계열에서 사용되는 크롬 클러스터로 거대 cage를 형성.": "A chromium cluster used in the MIL family that forms giant cages.",
    "ZIF-67의 코발트 노드 — 2-메틸이미다졸의 질소 4개와 사면체로 결합. ZIF-8(Zn)과 같은 소달라이트 골격의 코발트 버전.": "ZIF-67's cobalt node — tetrahedrally bound to four nitrogens of 2-methylimidazole. The cobalt version of the same sodalite framework as ZIF-8 (Zn).",
    "Mg-MOF-74의 마그네슘 노드 — 열린 금속 자리(open metal site)가 육각 채널 벽에 늘어서 CO₂를 강하게 붙잡음.": "Mg-MOF-74's magnesium node — open metal sites line the walls of the hexagonal channels and grab CO₂ strongly.",
    "MIL-53(Al)의 알루미늄 노드 — AlO₆ 팔면체가 사슬로 이어지며 1차원 채널의 뼈대를 형성. 게스트에 따라 채널이 열리고 닫히는 호흡(breathing)으로 유명.": "MIL-53(Al)'s aluminum node — AlO₆ octahedra link into chains that form the backbone of 1D channels. Famous for 'breathing' — channels open and close depending on the guest.",
    "금속 노드는 격자의 모서리 역할을 합니다.": "The metal node acts as the corner of the lattice.",
    "탄소 (벤젠 고리 또는 카르복실기의 일부)": "Carbon (part of a benzene ring or a carboxyl group)",
    "산소 (카르복실기 -COOH의 일부)": "Oxygen (part of a carboxyl group, -COOH)",
    "질소 (이미다졸 고리의 일부, ZIF계)": "Nitrogen (part of an imidazole ring, in ZIFs)",
    "수소 (벤젠 고리 C-H)": "Hydrogen (benzene-ring C-H)",
    "H₂O (물)": "H₂O (water)",
    "CH₄ (메탄)": "CH₄ (methane)",
    "벤젠": "Benzene",
    "비타민C": "Vitamin C",
    "이부프로펜": "Ibuprofen",
    "초소형 기공 (작은 가스만)": "Ultra-small pore (small gases only)",
    "HKUST-1 작은 기공급": "HKUST-1 small-pore class",
    "HKUST-1 큰 기공 / MOF-5급": "HKUST-1 large pore / MOF-5 class",
    "대형 기공 (큰 분자 가능)": "Large pore (fits big molecules)",
    "MIL-101급 초대형 기공": "MIL-101-class huge pore",
    "활성탄": "Activated carbon",
    "제올라이트": "Zeolite",
    "실리카겔": "Silica gel",
    "전체 보기": "Show all",
    "기공이 탐지되지 않았습니다": "No pores detected",
    "기공 크기 필터:": "Pore-size filter:"
  };
  ...
  // Translate a Korean body string on demand (for native dialogs like
  // confirm()/alert() that aren't in the DOM). Returns English only when
  // the current language is English and the string is known.
  function tr(ko) {
    if (current === 'en' && KO2EN[norm(ko)] != null) return KO2EN[norm(ko)];
    return ko;
  }
  ...
  window.I18N = {
    init: init, apply: apply, t: t, tr: tr, setLang: setLang, toggle: toggle,
